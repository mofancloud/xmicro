...
func TestBase32I(t *testing.T) {
	...
	for i := 0; i < 100; i++ {
		...
		sf := node.Generate()
		b32i := sf.Base32I()
		psf, err := ParseBase32I([]byte(b32i))
		if err != nil {
			t.Fatal(err)
		}
		if sf != psf {
...
func BenchmarkParseBase32I(b *testing.B) {
	...
	b.ResetTimer()
	for n := 0; n < b.N; n++ {
		ParseBase32I([]byte(b32i))
	}
}
func BenchmarkBase32I(b *testing.B) {
